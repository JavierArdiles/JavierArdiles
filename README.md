...
I´ve recently finished the Henry Bootcamp 🥾 where I learned all you need to know to get started in the web development industry: 🔧
...
One of the final projects of the bootcamp consisted in making a web page in which the user can find, sort, filter and create existing or fictional dog breeds. Check it out here --> [Dog App](https://github.com/JavierArdiles/PI-Dogs-FT16a) 🐶
